...
import { GrFacebook, GrPinterest, GrVimeo, GrInstagram, GrYoutube   } from 'react-icons/gr'
...
export default [
  ...
  {
    icon: <GrYoutube />,
    href: 'https://www.youtube.com/channel/UCjVjZL0axnqV9EFCrCp3yaQ',
    label: 'Michele Corley Clinical Skin Care on Youtube',
  },
  {
    icon: <GrPinterest />,
