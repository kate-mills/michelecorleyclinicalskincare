...
export default styled(ProLayoutNav)`
  & {
    width: 100%;
  ...
  classes: (
    <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
      ...
      <path
        ...
        stroke="#4E4E4E" strokeLinecap="round" strokeLinejoin="round" />
      <path
        ...
        fill="#4E4E4E" stroke="#4E4E4E" strokeWidth="0.5" />
    </svg>
